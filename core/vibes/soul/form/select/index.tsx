    ...
    <div className={clsx('w-full space-y-2', className)}>
      ...
      <SelectPrimitive.Root {...rest} value={value}>
        <SelectPrimitive.Trigger
          aria-label={label}
          className={clsx(
            'flex h-fit w-full select-none font-robotoslab items-center justify-between gap-3  bg-white p-2 px-5 py-3 text-sm font-medium text-foreground ring-primary transition-colors hover:border-contrast-300 hover:bg-contrast-100 focus-visible:outline-none focus-visible:ring-2',
