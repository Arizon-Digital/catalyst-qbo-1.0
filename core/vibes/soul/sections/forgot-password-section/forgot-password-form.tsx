...
function SubmitButton({ children }: { children: React.ReactNode }) {
  ...
  return (
    <Button 
      className="mt-auto w-auto h-5 mx-auto px-8 py-2 !bg-[#CA9618] -600 !border !border-[#CA9618] -600 !text-white rounded-md uppercase font-bold transition-colors duration-300 hover:!bg-white hover:!text-yellow-600 hover:!border-yellow-600" 
      loading={pending} 
      type="submit"
