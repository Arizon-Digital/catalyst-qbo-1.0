...
export function CartClient<LineItem extends CartLineItem>({
  ...
  // Kluber style (with modifications for the summary box)
  return (
    <div className="w-full px-4 sm:px-6 md:px-0 max-w-screen-xl mx-auto">
      ...
      <h1 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">
        Your Cart ({optimisticQuantity} items)
      </h1>
      ...
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
        ...
        {/* Checkout Summary Column - Boxed Style */}
    ...
    <form {...getFormProps(form)} action={action} className="flex items-center">
      ...
      <div className="flex items-center">
        <button
          ...
          className={clsx(
            'flex items-center justify-center w-8 h-8 bg-yellow-600 text-white',
        ...
        <span className="flex w-6 h-8 select-none justify-center items-center">
          {lineItem.quantity}
        </span>
        
        <button
          aria-label={incrementLabel}
          className="flex items-center justify-center w-8 h-8 bg-yellow-600 text-white hover:bg-yellow-700"
          name="intent"
          type="submit"
          value="increment"
        >
  ...
  return (
    <form {...getFormProps(form)} action={action} className="inline-flex items-center">
      ...
      <div className="flex items-center">
        ...
        <span className="flex w-4 sm:w-6 h-6 sm:h-8 select-none justify-center items-center px-1 sm:px-2 text-sm sm:text-base">
          {lineItem.quantity}
        </span>
