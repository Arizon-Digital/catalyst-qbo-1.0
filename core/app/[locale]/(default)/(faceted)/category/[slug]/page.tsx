...
import { ProductsListSection } from '@/arizon/soul/sections/products-list-section';
import { getFilterParsers } from '@/vibes/soul/sections/products-list-section/filter-parsers';
import { Filter } from '@/arizon/soul/sections/products-list-section/filters-panel';
...
async function getListProducts(props: Props): Promise<ListProduct[]> {
  ...
  return products.map((product) => ({
    ...
    image: product.defaultImage
      ? { src: product.defaultImage.urlResize, alt: product.defaultImage.altText }
      : undefined,
