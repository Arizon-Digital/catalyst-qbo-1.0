...
// import { useAccountStatusContext } from '~/app/[locale]/(default)/account/_components/account-status-provider';
...
interface RegisterCustomerProps {
  ...
  onAccountStateChange?: (state: { status: 'success' | 'error' }) => void;
}
...
export const RegisterCustomerForm = ({
  ...
  const onSubmit = async (formData: FormData) => {
    ...
    if (onAccountStateChange) {
      onAccountStateChange({ status: 'success' });
    }
