...
export function CartClient<LineItem extends CartLineItem>({
  ...
  // Check if we're on the client-side and then determine if it's mobile
  useEffect(() => {
  ...
  if (isMobile) {
    return (
      <div className="w-full px-4 max-w-[1580px] mx-auto mt-4 mb-4">
        ...
        <h1 className="text-center text-xl font-bold mb-4">
          Your Cart ({optimisticQuantity} {optimisticQuantity === 1 ? 'item' : 'items'})
        </h1>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="w-full">
            {optimisticLineItems.map((lineItem) => (
              <div key={lineItem.id} className="border border-gray-200 rounded-md mb-3 p-3">
                <div className="flex items-center">
                  ...
                  <div className="ml-3 flex-grow">
                    <div className="text-sm text-gray-500 font-robotoslab">
                      {lineItem.subtitle}
                    </div>
                    <div className="text-base font-medium font-robotoslab">
                      <Link 
                        href={lineItem.href} 
                    ...
                    <div className="text-sm font-medium mt-1 font-robotoslab">
                ...
                <div className="flex justify-between items-center mt-8 pt-2">
                  ...
                  <div className="text-right">
                    <div className="text-sm font-medium font-robotoslab">
                      Total: {formatPrice(lineItem.price)}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="w-full">
            <div className="border border-gray-200 p-4 rounded-md">
              ...
              <CheckoutButton 
                ...
                className="mt-4 w-full bg-[#CA9618] text-white font-robotoslab text-lg px-4 py-3 font-medium hover:bg-[#CA9618] transition-colors uppercase text-center"
              >
                CHECKOUT NOW
              </CheckoutButton>
      ...
      <form {...getFormProps(form)} action={action} className="inline-flex items-center">
        ...
        <div className="flex items-center">
          <button
            ...
            value="decrement"
          >
            <Minus size={isMobile ? 14 : 12} className={isMobile ? '' : 'sm:hidden'} />
            <Minus size={14} className={isMobile ? 'hidden' : 'hidden sm:block'} />
          </button>
          
          <span className={clsx(
            'flex select-none justify-center items-center px-1 sm:px-2 text-sm sm:text-base',
            isMobile ? 'w-8 h-8 px-2 text-base' : 'w-6 sm:w-8 h-6 sm:h-8'
          )}>
            {lineItem.quantity}
          </span>
          ...
          <button
            ...
            className={clsx(
              'flex items-center justify-center bg-[#CA9618] text-white rounded hover:bg-[#CA9618]',
            ...
            value="increment"
          >
            <Plus size={isMobile ? 14 : 12} className={isMobile ? '' : 'sm:hidden'} />
            <Plus size={14} className={isMobile ? 'hidden' : 'hidden sm:block'} />
          </button>
          ...
          <button
            ...
            className={clsx(
              ...
              isMobile ? 'ml-4' : 'ml-1 sm:ml-2'
            )}
            type="button" 
            onClick={handleDeleteClick}
          >
            <Trash2 size={isMobile ? 16 : 14} className={isMobile ? '' : 'sm:hidden'} />
            <Trash2 size={16} className={isMobile ? 'hidden' : 'hidden sm:block'} />
          </button>
        </div>
      </form>
