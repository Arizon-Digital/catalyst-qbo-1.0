...
export const Footer = forwardRef(function Footer(
  ...
  return (
    ...
    >
              ...
              <div>
                <div className="flex flex-col gap-3">
                  ...
                  <div className="mt-6 ml-12">
                    <h3 className="font-bold mb-2 text-sm font-robotoslab">FOLLOW US</h3>
      ...
      <div className="w-full py-4 bg-[#1c1c1c] text-white border-t border-white -700">
        <div className="max-w-screen-xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center font-robotoslab">
          <p className="text-white -400 text-sm mb-4 md:mb-0 text-center md:text-left font-robotoslab">
